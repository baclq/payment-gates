...
|    |   |   |   |   |- plugin.min.js
*/
    $none_path = isset($_SESSION['shop_id']) ? '/'.$_SESSION['shop_id'].'/' :'/';

	$path_dir = '../static/image/shop'.$none_path;
	$path_get_dir = '/image/shop'.$none_path;

	if (!file_exists('../../../'.$path_dir.'source')) {
		mkdir('../../../'.$path_dir.'source', 0775, true);
	}
	if (!file_exists('../../../'.$path_dir.'thumbs')) {
		mkdir('../../../'.$path_dir.'thumbs', 0775, true);
	}
	$upload_dir =$path_get_dir.'source/';
	$current_path = '../../../'.$path_dir.'source/';
	$thumbs_base_path = '../../../'.$path_dir.'thumbs/';
	$path_get_thumbs = '/image/shop'.$none_path .'thumbs/';
...
$config = array(
	...
	*/
	//'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'],
     ...
     'base_url' => 'https://static.salemall.vn',
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	//'upload_dir' => '/source/',
	//'upload_dir' => '/public/upload/source/',
	...
	*/
	...
	|
	*/
	//'thumbs_base_path' => '../../../public/upload/thumbs/',
	'thumbs_base_path' => $thumbs_base_path,

	'path_get_thumbs' => $path_get_thumbs,
	/*
	|--------------------------------------------------------------------------
